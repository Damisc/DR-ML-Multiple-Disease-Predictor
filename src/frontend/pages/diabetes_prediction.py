...
with col1:
    ...
    blood_presure = st.number_input("Blood Pressure", 0, 250, 150)
...
with col2:
    ...
    dpf = st.number_input("Diabetes Pedigree Function", 0.0, 3.0, 0.583)
...
if st.button("🔍 Predict", use_container_width=True):
    ...
    if prediction == 1:
        ...
        st.success("✅ Model Prediciton: Non - Diabetic")